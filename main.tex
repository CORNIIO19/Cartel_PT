...
\usepackage[size=custom,width=89,height=119,scale=1.60]{beamerposter}
\usetheme{ConfPoster}
...
\institute{Dr. Dominique Émile Henri Decouchant, Dr. Guillermo Monroy Rodríguez}
\begin{document}
\begin{frame}
...
% ------------------------------------------------------------
\begin{block}{\Large Dificultades identificadas}
...
\begin{center}
\includegraphics[width=0.95\linewidth]{Contexto_2.png}
\end{center}
...
% ------------------------------------------------------------
\begin{block}{\Large Contexto de Uso de la Aplicación}
...
% ------------------------------------------------------------
\begin{block}{\Large Sistema Clasificador}
...
% ------------------------------------------------------------
\begin{block}{\Large Conclusiones}
